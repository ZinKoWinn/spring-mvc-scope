...
import com.example.springmvcscope.beans.ApplicationScopeBean;
import com.example.springmvcscope.beans.RequestScopeBean;
import com.example.springmvcscope.beans.SessionScopeBean;
...
public class IndexController {
    ...
    public String sessionScopeValue(@RequestParam("sessionScopeValue") int sessionScopeValue) {
        sessionScopeBean.setValue(sessionScopeValue);
        return "forward:/";
    }

    @PostMapping("saveApplicationScopeValue")
    public String applicastionScopeValue(@RequestParam("applicationScopeValue") int applicationScopeValue) {
